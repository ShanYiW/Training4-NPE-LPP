...
lb_d=2; ub_d=floor(L*N_class*0.7);
len_d = ub_d-lb_d+1;
lb_k=5; ub_k=floor(L*N_class*0.7); step_k=5; % ub_k<=90
len_k = floor((ub_k-lb_k)/step_k) + 1;
...
for k=lb_k:step_k:ub_k
    ...
    for rnd = 1:N_rnd
        ...
        [Wpca,Wlpp,D_12] = LapFace_my(trainset, k, t); % E: D*D
...
Color = [237,177,32;
    ...
    0,0,255;
    255,0,0]./255;
node_shape =['+-';'x-';'<-';'>-';'v-';'^-';'o-';'s-';'p-';'*-'; 'o:';'*:';'s:';'.-';'^:';'p:'];
figure('Name', ['L',num2str(L),'_t',num2str(t)]);
for k=1:len_k
...
legend('$k=5$', '$k=10$', '$k=15$', '$k=20$', '$k=25$','$k=30$','$k=35$',...
    ...
    '$k=75$','$k=80$','Interpreter','latex','Location','southeast','Fontsize',12);
hold off;
end